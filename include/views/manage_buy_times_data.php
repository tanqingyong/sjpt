...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/buy_times_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/export_buy_times_data.php');
    $("form:first").submit();
}
                        ...
                        <select id="end1" name="end1" class="se_ect1">
                         ...
                         <div class="table-data-box">
                                   <table cellpadding="0" cellspacing="0"   style="width:100%" >
								    <thead>
								    	<tr><td>月份</td><td>购买1次用户数</td><td>购买2次用户数</td><td>购买3次用户数</td>
