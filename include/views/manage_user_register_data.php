...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/whole_site/user_register_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/whole_site/export_user_register_data.php');
    $("form:first").submit();
}
                        ...
                        <div class="right-data"  >
                         ...
                         <div class="table-data-box">
                                   <table cellpadding="0" cellspacing="0"   style="width:1400px" >
								    <thead>
								    	<tr><td>日期</td><td>下单数</td><td>下单用户数</td><td>下单商品数</td><td>下单总额</td><td>下单客单价</td><td>订单转化率</td><td>付款订单数</td><td>付款用户数</td><td>付款商品数</td><td>付款订单总额</td><td>付款客单价</td><td>付款转化率</td></tr>
								    </thead>				 
									<tbody>		
