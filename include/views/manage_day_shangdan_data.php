...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/day_report/day_shangdan_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/day_report/export_day_shangdan_data.php');
    $("form:first").submit();
}
                        ...
                        <div class="right-data"  >
                         ...
                         <div class="table-data-box">
                                   <table cellpadding="0" cellspacing="0"   style="width:100%" >
								    <thead>
								    	<tr><td>日期</td><td>上线城市</td><td>上线商品数</td><td>新商品支付金额</td></tr>
								    </thead>				 
									<tbody>		
