...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/refund_city_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/export_refund_city_data.php');
    $("form:first").submit();
}
                        ...
                        <div class="right-data"  >
                         ...
                         <div class="table-data-box">
                                   <table cellpadding="0" cellspacing="0"   style="width:100%" >
								    <thead>
								    	<tr><td>日期</td><td>城市</td><td>退款用户数</td><td>退款笔数</td>
								    	<td>退款商品份数</td><td>退款金额</td><td>用户退款率</td></tr>
								    </thead>			 
									<tbody>		
