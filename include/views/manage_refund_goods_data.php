...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/refund_goods_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/export_refund_goods_data.php');
    $("form:first").submit();
}
...
<!--									</td>-->
                         ...
                         <div class="table-data-box">
                                   <table cellpadding="0" cellspacing="0"   style="width:100%" >
								    <thead>
								    	<tr><td>日期</td><td>商品ID</td><td>退款用户数</td><td>退款笔数</td>
								    	<td>退款商品份数</td><td>退款金额</td><td>用户退款率</td><td>累计退款用户数</td>
								    	<td>累计退款笔数</td><td>累计退款商品份数</td><td>累计退款金额</td></tr>
								    </thead>			 
									<tbody>		
							   <?php foreach($datas as $data){?>
										<tr><td><?php echo $data['date'];?></td>
											<td><?php echo $data['goods_id'];?></td>
											<td><?php echo $data['refund_user'];?></td>
											...
											<td><?php echo $data['refund_total_user'];?></td>
											<td><?php echo $data['refund_total_items'];?></td>
											<td><?php echo $data['refund_total_goods_num'];?></td>
											<td><?php echo $data['refund_total_money'];?></td>
										</tr>
										<?php }
										if($data_sum){
										?>
										<tr><td><?php echo $data_sum['date'];?></td>
											<td><?php echo $data_sum['goods_id'];?></td>
											<td><?php echo $data_sum['refund_user'];?></td>
											<td><?php echo $data_sum['refund_items'];?></td>
											<td><?php echo $data_sum['refund_goods_num'];?></td>
											<td><?php echo $data_sum['refund_money'];?></td>
											<td><?php echo round($data_sum['refund_user']/$data_sum['buy_user']*100,2);?>%</td>
											<td><?php echo $data_sum['refund_total_user'];?></td>
											<td><?php echo $data_sum['refund_total_items'];?></td>
											<td><?php echo $data_sum['refund_total_goods_num'];?></td>
											<td><?php echo $data_sum['refund_total_money'];?></td></tr>
										<?php }
										if(!$datas){?>
