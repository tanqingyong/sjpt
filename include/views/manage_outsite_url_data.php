...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/whole_site/outsite_url_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/whole_site/export_outsite_url_data.php');
    $("form:first").submit();
}
                        ...
                        <div class="right-data"  >
                         ...
                         <div class="table-data-box">
                                   <table cellpadding="0" cellspacing="0"   style="width:100%px" >
								    <thead>
								    	<tr><td>日期</td><td>URL</td><td>PV</td><td>UV</td><td>IP</td></tr>
								    </thead>				 
									<tbody>		
