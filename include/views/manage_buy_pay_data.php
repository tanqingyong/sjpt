...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/buy_pay_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/user_center/export_buy_pay_data.php');
    $("form:first").submit();
}
                        ...
                        <select id="type" name="type" class="se_ect1">
                         ...
                         <div class="table-data-box">
                                   <table cellpadding="0" cellspacing="0"   style="width:800px" >
								    <thead>
								    	<tr><td>日期</td><td>支付类型</td><td>支付订单数</td><td>支付用户数</td><td>支付金额</td></tr>
								    </thead>			 
									<tbody>		
