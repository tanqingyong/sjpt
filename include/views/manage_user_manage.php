...
<tr>
	...
	<td>是否在线</td>
	<td><select name="online" class="f-city">
		<option></option>
				            <?php
				            $option_online=array('1'=>'在线','00'=>'离线');
									echo '' . Utility::Option ( $option_online, $online ) . '';
									?>
				            </select></td>							
								<td>
...
<table  cellspacing="0" cellpadding="0">
	...
	<tr>
			...
			<td width="150">部门</td>
			<td width="100">权限</td>
			<td width="200">登录时间</td>
			<td width="120">在线状态</td>
			<td width="150">操作</td>
		</tr>
	</thead>
	<?php
	...
	foreach ( $users as $one ) {
		...
		$str .="</td>";
		$create_date = date ( 'Y-m-d H:i', $one ['login_time'] );
		$str .="<td>".$create_date."</td>";
		...
		$str .= get_online_status($one ['online_status'])." </td>";
		$str .="<td class='op'>";
