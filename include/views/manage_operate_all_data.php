...
function cha_xun(){
    $("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/dailymedia/operate_all_data.php');
    $("form:first").submit();
}
function export_excel(){
    $("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/dailymedia/export_operate_all_data.php');
    $("form:first").submit();
}
...
<table cellpadding="0" cellspacing="0" style="width: 1000px">
	...
	<?php foreach($datas as $data){?>
		<tr>
			...
			<td><?php echo $data['old_ip'];?></td>
			<td><?php echo $data['old_uv'];?></td>
			<td><?php echo $data['old_pv'];?></td>
			<td><?php echo $data['new_ip'];?></td>
			<td><?php echo $data['new_uv']?></td>
			<td><?php echo $data['new_pv'];?></td>
