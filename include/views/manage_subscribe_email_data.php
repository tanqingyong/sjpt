...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/flow/subscribe_email_data.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/flow/export_subscribe_email_data.php');
    $("form:first").submit();
}
...
<table cellpadding="0" cellspacing="0" style="width: 600px">
	...
	<?php foreach($datas as $data){?>
		<tr>
			...
			<td><?php echo $data['emaildy_pv'];?></td>
		</tr>
		<?php }?>
		<?php if(!$datas){?>
		<tr>
