...
function cha_xun(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/whole_site/out_visit_domain.php');
    $("form:first").submit();
}
function export_excel(){
	$("form:first").attr('action','<?php echo WEB_ROOT;?>/manage/operation/whole_site/export_out_visit_domain.php');
    $("form:first").submit();
}
                        ...
                        <div class="right-data"  >
                         ...
                         <div class="table-data-box">
							  ...
							  <thead>
							   <tr><td>日期</td><td>域名</td><td>PV</td><td>UV</td><td>IP</td><td>跳出率</td></tr> 
							  </thead>
							  <tbody>
								   <?php foreach($datas as $data){?>			 
											<tr><td><?php echo $data['data_date'];?></td>
												<td width="60px"><?php echo $data['domain_name'];?></td>
