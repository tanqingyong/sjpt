...
if(array_key_exists($current_menu_url,$all_menu_url)){
	$insert_Id = DB::Insert('menu_log',array('user_id'=>$_SESSION['user_id'],'ip'=>Utility::GetRemoteIp(),'menu_id'=>$all_menu_url[$current_menu_url],'action_time'=>time(),'username'=>$_SESSION['user_name']));
}
