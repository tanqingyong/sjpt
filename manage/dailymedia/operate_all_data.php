...
$sql_count = "select count(1) as count from operate_all_data where 1=1 ".$condition;
...
$sql = "select * from operate_all_data o where 1=1 $condition  limit $offset,$pagesize  ";

$datas = DB::GetQueryResult($sql,false);



echo template ( 'manage_operate_all_data',
                array ('datas'=>$datas,
