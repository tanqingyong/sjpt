...
$sql_count = "select count(1) as count from web_country_day_url a where 1=1 ";
...
$sql .="order by a.data_date desc,a.pv desc  limit $offset,$pagesize;";

$datas = DB::GetQueryResult($sql,false);

echo template ( 'manage_outsite_url_data', 
