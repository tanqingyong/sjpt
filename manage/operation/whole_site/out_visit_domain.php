...
need_login();
need_page();
$sql = "select data_date,domain_name,pv,uv,ip,click_onlyone_ratio from country_day_outfromdomain a where 1=1 ";
$sql_count = "select count(1) as count from country_day_outfromdomain a where 1=1 ";
...
echo template ( 'manage_out_visit_domain', 
