...
need_login();
need_page();
$sql = "SELECT date,pindao,list_page,PV,uv,ip,zhuolu_uv/uv as 'logout_rate' from product_logout_page where 1=1 ";
$sql_count = "select count(1) as count from product_logout_page where 1=1 ";
...
echo template ( 'manage_logout_page_data',
array ( 'datas'=>$datas,
