...
$sql_count = "select count(1) as count from buy_times where 1=1 ";
...
$condition .=" and id >=(SELECT if(id>=1,min(id),1) from buy_times where months='".$start1."-".$start2."') AND id <=(SELECT max(id) from buy_times where months<='".$end1."-".$end2."')";
$sql .= $condition;
$sql_count .= $condition;
...
echo template ( 'manage_buy_times_data',
array ( 'datas'=>$datas,
