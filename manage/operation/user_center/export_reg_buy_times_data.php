...
//$condition .=" and b.id >=(SELECT min(id) from buy_times where months>='".$start1."-".$start2."') AND b.id <=(SELECT max(id) from buy_times where months<='".$end1."-".$end2."')";

$sql .= $condition;


$datass = DB::GetQueryResult ( $sql." order by months  ;", false ); 
