...
$sql_count = "select count(1) as count from goods_detail a where 1=1 ";
...
$sql .="order by a.date desc,a.pv desc limit $offset,$pagesize;";

$datas = DB::GetQueryResult($sql,false);

echo template ( 'manage_detailpage_visit_url', 
