...
$sql_count = "select count(distinct date) as count from shangdan where 1=1 ";
...
$sql .=" group by date order by date  limit $offset,$pagesize;";

$datas = DB::GetQueryResult($sql,false);

echo template ( 'manage_day_shangdan_all_data', 
