...
$sql_count = "select count(1) as count from  zaixian_sale where 1=1 ";
...
echo template ( 'manage_day_zaixian_data', 
                array ( 'datas'=>$datas,'pagestring'=>$pagestring,'filter_date_start'=>$filter_date_start,'filter_date_end'=>$filter_date_end,'city_name'=>$city_name,'page_size'=>$page_size) );
