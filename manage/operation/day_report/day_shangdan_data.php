...
need_login();
need_page();
$sql = "select * from shangdan where 1=1 ";
$sql_count = "select count(1) as count from shangdan where 1=1 ";
...
$sql_count .= " and city_name='$city_name' ";	
}
...
echo template ( 'manage_day_shangdan_data', 
